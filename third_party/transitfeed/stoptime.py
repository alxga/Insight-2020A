  ...
  """
    ...
    def __init__(
        ...
        if (
            ...
            and self.arrival_secs is None
            and self.departure_secs is None
        ):
        ...
        if (
            (self.arrival_secs is not None)
            and (self.departure_secs is not None)
        ...
        if (
            self.departure_secs is not None
            and self.arrival_secs is None
